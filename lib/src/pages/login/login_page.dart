...
import 'package:udemy_flutter/src/pages/login/login_controller.dart';
    ...
    return Scaffold(
        ...
        body: Stack(
          ...
          children: <Widget>[
            ...
            _boxForm(context),
            Column(
              // POSIONA ELEMENTOS UNO DEBAJO DEL OTRO (VERTICAL)
              children: <Widget>[_imageCover(), _textAppName()],
            )
          ],
        ));
  }
